...
import { CAMISETA_PLACEHOLDER, OPCIONES_CONTINENTES, OPCIONES_TIPO } from "../../Constants/Constants";
...
export default function Carga() {
  ...
  const [previsualizacion, setPrevisualizacion]= useState(CAMISETA_PLACEHOLDER);
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      ...
      <View style={styles.formularioContainer}>
        ...
        <TextInput
          style={styles.input}
          value={temporada}
          onChangeText={(texto) => {setTemporada(texto)}}
        ...
        <Text style={styles.exitoFoto}>{!exitoFoto ? "No se encontró una foto" : null}</Text>
      ...
      >
        ...
        <Text style={styles.label}>Equipo</Text>
          ...
          style={styles.input}
          value={equipo}
          onChangeText={(valorEquipo) => {setEquipo(valorEquipo)}}
        ...
        />
          ...
          style={styles.input}
          value={liga}
          onChangeText={(valorLiga) => {setLiga(valorLiga)}}
          placeholder="Ingrese el nombre del equipo"
          keyboardType="default"
          autoCapitalize="words"
        />
